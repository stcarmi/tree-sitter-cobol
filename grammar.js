...
module.exports = grammar({
  ...
  rules: {
    ...
    exec_sql_keyword: $ => choice(
      /[aA][bB][cC][oO][dD][eE]/,
      /[aA][bB][eE][nN][dD]/,
      /[aA][bB][sS][tT][iI][mM][eE]/,
      /[aA][dD][dD]/,
      /[aA][fF][tT][eE][rR]/,
      /[aA][lL][lL]/,
      /[aA][lL][lL][oO][cC][aA][tT][eE]/,
      /[aA][lL][tT][eE][rR]/,
      /[aA][nN][dD]/,
      /[aA][nN][yY]/,
      /[aA][pP][pP][lL][iI][dD]/,
      ...
      /[dD][eE][lL][eE][tT][eE]/,
      /[dD][eE][lL][eE][tT][eE][qQ]/,
      /[dD][eE][qQ][uU][eE][uU][eE]/,
      /[dD][eE][sS][cC]/,
      /[dD][eE][sS][cC][eE][nN][dD][iI][nN][gG]/,
      /[dD][eE][sS][cC][rR][iI][bB][eE]/,
      /[dD][eE][sS][cC][rR][iI][pP][tT][oO][rR]/,
      /[dD][fF][hH][cC][oO][mM][mM][aA][rR][eE][aA]/,
      /[dD][fF][hH][rR][eE][sS][pP]/,
      /[dD][iI][aA][gG][nN][oO][sS][tT][iI][cC][sS]/,
      /[dD][iI][sS][aA][bB][lL][eE][dD]/,
      /[dD][iI][sS][cC][oO][nN][nN][eE][cC][tT]/,
      /[dD][iI][sS][tT][iI][nN][cC][tT]/,
      /[dD][oO][cC][tT][oO][kK][eE][nN]/,
      /[dD][oO][cC][uU][mM][eE][nN][tT]/,
      /[dD][rR][oO][pP]/,
      /[dD][uU][pP][kK][eE][yY]/,
      /[dD][uU][pP][rR][eE][cC]/,
      /[dD][yY][nN][aA][mM][iI][cC]/,
      /[eE][iI][bB][cC][aA][lL][eE][nN]/,
      /[eE][iI][bB][rR][sS][rR][cC][eE]/,
      /[eE][iI][bB][tT][rR][nN][iI][dD]/,
      /[eE][lL][sS][eE]/,
      /[eE][nN][dD]/,
      /[eE][nN][dD][bB][rR]/,
      /[eE][nN][dD][fF][iI][lL][eE]/,
      ...
      /[fF][iI][lL][eE]/,
      /[fF][iI][rR][sS][tT]/,
      /[fF][lL][eE][nN][gG][tT][hH]/,
      /[fF][lL][oO][aA][tT]/,
      /[fF][oO][rR]/,
      /[fF][oO][rR][eE][iI][gG][nN]/,
      /[fF][oO][rR][mM][aA][tT][tT][iI][mM][eE]/,
      /[fF][rR][eE][eE][mM][aA][iI][nN]/,
      /[fF][rR][oO][mM]/,
      /[fF][uU][lL][lL]/,
      /[gG][eE][nN][eE][rR][iI][cC]/,
      /[gG][eE][tT]/,
      /[gG][eE][tT][mM][aA][iI][nN]/,
      /[gG][lL][oO][bB][aA][lL]/,
      /[gG][oO]/,
      /[gG][oO][tT][oO]/,
      /[gG][rR][aA][nN][tT]/,
      ...
      /[iI][sS]/,
      /[iI][tT][eE][mM]/,
      /[jJ][fF][iI][lL][eE][iI][dD]/,
      /[jJ][oO][iI][nN]/,
      /[jJ][oO][uU][rR][nN][aA][lL]/,
      /[jJ][tT][yY][pP][eE][iI][dD]/,
      /[kK][eE][yY]/,
      /[kK][eE][yY][lL][eE][nN][gG][tT][hH]/,
      /[lL][aA][bB][eE][lL]/,
      /[lL][eE][fF][tT]/,
      /[lL][eE][nN][gG][eE][rR][rR]/,
      /[lL][eE][nN][gG][tT][hH]/,
      /[lL][iI][kK][eE]/,
      /[lL][iI][mM][iI][tT]/,
      /[lL][iI][nN][kK]/,
      ...
      /[nN][eE][tT][nN][aA][mM][eE]/,
      /[nN][eE][xX][tT]/,
      /[nN][oO][hH][aA][nN][dD][lL][eE]/,
      /[nN][oO][sS][pP][aA][cC][eE]/,
      /[nN][oO][tT]/,
      /[nN][oO][tT][fF][nN][dD]/,
      /[nN][oO][tT][oO][pP][eE][nN]/,
      /[nN][uU][lL][lL]/,
      /[nN][uU][lL][lL][sS]/,
      /[nN][uU][mM][iI][tT][eE][mM][sS]/,
      /[oO][fF][fF][sS][eE][tT]/,
      /[oO][nN]/,
      /[oO][nN][lL][yY]/,
      /[oO][pP][eE][nN]/,
      ...
      /[pP][aA][rR][tT][iI][tT][iI][oO][nN][eE][dD]/,
      /[pP][gG][mM][iI][dD][eE][rR][rR]/,
      ...
      /[qQ][uU][eE][uU][eE]/,
      /[rR][eE][aA][dD]/,
      /[rR][eE][aA][dD][nN][eE][xX][tT]/,
      /[rR][eE][aA][dD][pP][rR][eE][vV]/,
      /[rR][eE][aA][dD][qQ]/,
      ...
      /[rR][eE][qQ][iI][dD]/,
      /[rR][eE][sS][eE][tT][bB][rR]/,
      /[rR][eE][sS][iI][gG][nN][aA][lL]/,
      /[rR][eE][sS][oO][uU][rR][cC][eE]/,
      /[rR][eE][sS][pP]/,
      /[rR][eE][sS][uU][lL][tT]/,
      /[rR][eE][tT][rR][iI][eE][vV][eE]/,
      /[rR][eE][tT][uU][rR][nN]/,
      /[rR][eE][vV][oO][kK][eE]/,
      /[rR][eE][wW][rR][iI][tT][eE]/,
      /[rR][iI][dD][fF][lL][dD]/,
      /[rR][iI][gG][hH][tT]/,
      ...
      /[sS][iI][gG][nN][aA][lL]/,
      /[sS][oO][mM][eE]/,
      /[sS][qQ][lL][eE][rR][rR][oO][rR]/,
      /[sS][qQ][lL][wW][aA][rR][nN][iI][nN][gG]/,
      /[sS][tT][aA][rR][tT]/,
      /[sS][tT][aA][rR][tT][bB][rR]/,
      /[sS][tT][aA][tT][iI][cC]/,
      /[sS][tT][oO][gG][rR][oO][uU][pP]/,
      /[sS][tT][rR][iI][pP]/,
      /[sS][uU][bB][sS][tT][rR]/,
      /[sS][uU][bB][sS][tT][rR][iI][nN][gG]/,
      /[sS][uU][mM]/,
      /[sS][uU][sS][pP][eE][nN][dD]/,
      /[sS][yY][nN][cC][pP][oO][iI][nN][tT]/,
      /[sS][yY][sS][iI][dD]/,
      /[tT][aA][bB][lL][eE]/,
      /[tT][aA][bB][lL][eE][sS][pP][aA][cC][eE]/,
      /[tT][dD]/,
